...
public class RecipeSerializerInit {
	...
	public static final DeferredRegister<IRecipeSerializer<?>> recipe_serializer = DeferredRegister
			.create(ForgeRegistries.RECIPE_SERIALIZERS, HypixelSkyBlockMod.MOD_ID);
